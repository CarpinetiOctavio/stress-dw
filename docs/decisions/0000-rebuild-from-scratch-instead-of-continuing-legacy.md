...
* Lessons to carry over: `treatment` modeled as a measure, not a dimension attribute (the legacy corrected this late: Phase 3, "Dim_Acces: Correction" (Spanish: "Dim_Acceso: Corrección")); additive measures; explicit grain.
