...
* Lessons to carry over: `treatment` modeled as a measure, not a dimension attribute (the legacy corrected this late: Phase 3, "Dim_Acceso: Corrección" (English: "Dim_Acceso: Correction")); additive measures; explicit grain.
