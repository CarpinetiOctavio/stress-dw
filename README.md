...
Work in progress. A dimensional data warehouse (star schema, MySQL, Python ETL) built with the Hefesto methodology, rebuilt from scratch after an audit of a university course project.
